...
- 3.8.10
	- This release contains some fixes and improvements that have been backported from 4.x.
...
- 3.8.9 (2017-04-26)
	- This release contains some fixes and improvements that have been backported from the 4.0 release.
	...
	- Fixed DynamicGridObstacle getting caught in an infinite loop if there was be no AstarPath component in the scene when it was created. Thanks MeiChen for finding the bug.
	...
	- Fixed Path.immediateCallback not being reset to null when using path pooling. This could lead to a memory leak in some cases.
